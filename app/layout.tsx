...
export const metadata: Metadata = {
  title: 'Hotel and Resturant Furniture | Vijayawada',
  description,
  applicationName: business.name,
  ...(siteUrl ? { metadataBase: new URL(siteUrl), alternates: { canonical: '/' } } : {}),
  robots: { index: Boolean(siteUrl), follow: true },
  openGraph: {
    title: 'Furniture for the way you welcome | Hotel and Resturant Furniture',
    description,
  ...
  twitter: { card: 'summary_large_image', title: 'Hotel and Resturant Furniture | Vijayawada', description },
  category: 'furniture',
